...
Pixel Animator, **kare kare** animasyonu ile **Unity hitbox**'ları senkronize etmek için Unity dahilinde geliştirdiğim bir araç. Ve yanında bi kaç ek özelliklerde var.
...
*Fakat yinede hangi animatör daha rahatsa onu kullanmanız çok daha iyi.*